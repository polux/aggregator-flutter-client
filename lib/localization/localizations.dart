...
import 'package:flutter_reader/localization/localizations/messages_all.dart';
...
class ReaderLocalizations {
  ...
  static Future<ReaderLocalizations> load(Locale locale) {
    return initializeMessages(locale.toString()).then((_) {
      return new ReaderLocalizations(locale);
    });
  }
  ...
  String get showUnread => Intl.message(
        'Show Unread',
        name: 'showUnread',
        args: [],
        locale: locale.toString(),
...
class ReaderLocalizationsDelegate
  ...
  Future<ReaderLocalizations> load(Locale locale) =>
      ReaderLocalizations.load(locale);
